...
document.getElementById('get1').addEventListener('click', () => postId(1));
document.getElementById('get2').addEventListener('click', () => postId(2));
document.getElementById('get3').addEventListener('click', () => postId(3));
document.getElementById('get4').addEventListener('click', () => postId(4));
document.getElementById('get5').addEventListener('click', () => postId(5));
